...
var game = new Phaser.Game(528, 400, Phaser.AUTO, 'game', { preload: preload, create: create, update: update });
...
function preload() {
    game.load.spritesheet("GEMS", "../images/diamonds32x5.png", GEM_SIZE, GEM_SIZE);
}
